...
out.push('')
out.push('Invariant builds autonomous AI agents that draft, file, and monitor regulatory and qualification compliance for companies in space, aerospace, and nuclear. The agents ingest design docs, test data, and the regulations that apply, then produce regulator-grade submissions, test plans, and verification/compliance matrices end to end, with every claim traced back to the rule that supports it. A small team of domain engineers handles deployment and high-stakes review. Backed by Entrepreneur First, Transpose Platform, Boundless Ventures, and NPU Ventures.')
out.push('')
out.push('## Key facts')
out.push('')
