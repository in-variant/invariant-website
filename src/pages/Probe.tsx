...
const DEMO_RESULTS: Record<string, SearchResult[]> = {
  ...
  'emergency planning': [
    ...
    { chunk_id: 175040, doc_id: 'www.nrc.gov/docs/ML2334/ML23348A082.pdf', title: 'RG 4.7 Rev 4 (DG-4034) General Site Suitability for NPP', chunk_index: 43, score: 25.2713, text: 'NRC requirements pertaining to emergency planning were first developed in 10 CFR Part 50 (050.47 and Appendix E) with respect to construction permits and operating licenses. NRC reviews and approves emergency plans in consultation with the Federal Emergency Management Agency (FEMA), as described in NUREG-0654/FEMA-REP-1.' },
