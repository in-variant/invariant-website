      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  isCenter ? "z-20 shadow-emerald-500/10" : "z-10"
                )}
                initial={false}
                animate={{
                  x: xOffset,
        ...
        <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1 rounded-full bg-[#111]/80 p-1 ring-1 ring-white/10 backdrop-blur-md">
              <button
                onClick={handlePrev}
            ...
            {activeItem.href && (
              <Link
                to={activeItem.href}
                className="group flex items-center gap-2 rounded-full bg-emerald-500 px-5 py-3 text-sm font-semibold text-white transition-transform hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(16,185,129,0.3)]"
              >
                Explore
