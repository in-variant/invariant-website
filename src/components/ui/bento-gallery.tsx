          ...
          >
            {imageItems.map((item) => (
              <motion.div
                ...
                className={cn(
                  "group relative flex h-full min-h-[18rem] w-full min-w-[18rem] cursor-pointer items-end overflow-hidden rounded-xl border border-white/10 bg-[#111] p-4 shadow-sm transition-shadow duration-300 ease-in-out hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500",
                  item.span,
                )}
              ...
              >
                ...
                />
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-60 transition-opacity duration-500 group-hover:opacity-100" />
