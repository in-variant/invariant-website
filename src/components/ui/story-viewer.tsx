...
function StoryViewerModal({
  ...
  return (
    <motion.div
      className="fixed inset-0 z-[60] bg-black flex items-center justify-center p-0 md:p-4"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      <motion.div
        ref={containerRef}
        className="relative w-full h-full max-w-lg mx-auto flex flex-col overflow-hidden md:rounded-2xl"
      ...
      >
        <div className="absolute top-0 left-0 right-0 z-10 pt-4 pb-12 bg-gradient-to-b from-black/80 to-transparent">
          <ProgressBar
          ...
          <div className="flex items-center justify-between px-4 mt-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-white text-sm font-semibold shadow-sm">{username}</span>
                {timestamp && (
            ...
            <div className="flex items-center gap-1">
              {isPaused && (
                <div className="flex items-center gap-1.5 text-white/90 mr-2 bg-black/20 px-2 py-1 rounded-full backdrop-blur-sm">
              ...
              {currentStory.type === "video" && (
                <button
                  ...
                  className={cn(
                    ...
                    "h-9 w-9 text-white hover:bg-white/20 transition-colors",
        ...
        <div
          className="flex-1 flex items-center justify-center overflow-hidden bg-zinc-950 select-none relative"
          onClick={handleTap}
        >
        ...
        <div className="md:flex absolute inset-y-0 left-0 right-0 items-center justify-between pointer-events-none px-4 z-20">
          <button
            type="button"
            className={cn(
              "hidden md:inline-flex items-center justify-center",
              "h-12 w-12 rounded-full bg-white/5 text-white hover:bg-white/20 transition-colors pointer-events-auto border border-white/5 backdrop-blur-sm",
              "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50",
